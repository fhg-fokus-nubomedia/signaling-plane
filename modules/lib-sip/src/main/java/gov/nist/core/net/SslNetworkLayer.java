...
import gov.nist.core.vertx.VertxNetworkLayer;
 ...
 *
 */
public class SslNetworkLayer implements VertxNetworkLayer {
...
//            return new Socket(address, port);
    ...
    @Override
    public NetServer createServerSocket(int backlog) throws IOException {
        return null;
    }
    ...
    @Override
    public NetClient createNetClientSocket() throws IOException {
        return null;
    }

    @Override
    public NetServer createSSLServerSocket(int backlog, boolean clientTrust) throws IOException {
        return null;
    }

    @Override
    public NetClient createSSLNetClient(boolean serverTrust) throws IOException {
        return null;
    }

    @Override
    public org.vertx.java.core.datagram.DatagramSocket createDatagramSocket(InternetProtocolFamily type) throws SocketException {
        return null;
    }
