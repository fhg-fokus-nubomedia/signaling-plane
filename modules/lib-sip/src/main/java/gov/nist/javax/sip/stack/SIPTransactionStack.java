...
import gov.nist.core.vertx.DefaultVertxNetworkLayer;
...
public abstract class SIPTransactionStack implements
    ...
    /*
     * Class that handles Vertx network socket
     */
    ...
    protected VertxNetworkLayer networkLayer;
     ...
     * Default constructor.
     */
    protected SIPTransactionStack(Vertx vertx) {
        this.toExit = false;
        ...
        //Create Networklayer
        this.vertx = vertx;
        this.networkLayer = new DefaultVertxNetworkLayer(vertx);
...
//        String branchId = ((SIPRequest)serverTransaction.getRequest()).getTopmostVia().getBranch();
     ...
     */
    protected SIPTransactionStack(StackMessageFactory messageFactory, Vertx vertx) {
        this(vertx);
     ...
     */
    public VertxNetworkLayer getNetworkLayer() {
        return networkLayer;
    }
...
//        } else 
    ...
    /**
    * Find suitable MessageProcessor and calls it's  method passing
    ...
    * @return result of invocation of if MessageProcessor was found
    */
