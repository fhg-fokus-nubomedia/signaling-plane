...
public class DefaultRouter implements Router {
    ...
    public Hop getNextHop(Request request) throws SipException {
        ...
        if (routes != null) {
            ...
            if(route==null) System.out.println("Route is null");
            else if(route.getAddress()==null) System.out.println("Route address is null");
            else if(route.getAddress().getURI()==null) System.out.println("Route address URI is null");
            
            URI uri = route.getAddress().getURI();
            if (uri.isSipURI()) {
                SipURI sipUri = (SipURI) uri;
                if (!sipUri.hasLrParam()) {
                   //ToDo(lwo): build a switch for fixStrictRouting function
