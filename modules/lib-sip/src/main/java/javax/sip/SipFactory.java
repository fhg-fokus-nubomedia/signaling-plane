 ...
 * Copyright ï¿œ 2003 Sun Microsystems, Inc. All rights reserved.
 * Copyright ï¿œ 2005 BEA Systems, Inc. All rights reserved.
 *
 ...
 * e.g. to create a peer SipStack, an application would invoke the method.
 * <p>
...
public class SipFactory {
    ...
    public synchronized static SipFactory getInstance() {
       ...
       */
    public synchronized SipStack createSipStack(Properties properties, Vertx vertx)
            throws PeerUnavailableException {
        ...
        if ( ipAddress == null) {
            ...
            if (mySipStack == null) {
                mySipStack = createStack(properties, vertx);
            }
            return mySipStack;
        } else {
            ...
            return createStack(properties, vertx);
        }
    ...
    private SipStack createStack(Properties properties, Vertx vertx) throws PeerUnavailableException {
        try {
            SipStack sipStack = new SipStackImpl(properties, vertx);
