...
//	default public void writeData(DataOutput out) throws IOException {
//		LoggerFactory.getLogger("SessionHandler").w("Cannot serialize object: writeData is not yet implemented");
//	}
//
//	default public void readData(DataInput in) throws IOException {
//		LoggerFactory.getLogger("SessionHandler").w("Cannot deserialize object: readData is not yet implemented");
//	}
}
